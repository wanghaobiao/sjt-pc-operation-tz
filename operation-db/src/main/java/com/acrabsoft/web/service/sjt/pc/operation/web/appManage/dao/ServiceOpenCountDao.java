...
import com.acrabsoft.web.service.sjt.pc.operation.web.appManage.entity.ServiceOpenCountEntity;
...
/**
* 服务每日应用调用次数统计( ServiceOpenCountDao )Dao类
* @author wanghb
* @since 2021-4-21 14:46:49
*/
@Repository
public class ServiceOpenCountDao extends BaseController {
    @Autowired
    ...
    */
    public void batchLogicDelete(List<String> ids) {
        ...
        SQL sql = new SQL();
        sql.UPDATE( ServiceOpenCountEntity.tableName );
