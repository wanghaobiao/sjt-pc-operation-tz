...
import com.acrabsoft.web.service.sjt.pc.operation.web.appManage.entity.AppHourActiveCountEntity;
...
/**
* 应用分时活跃用户统计( AppHourActiveCountDao )Dao类
* @author wanghb
* @since 2021-4-23 14:22:40
*/
@Repository

public class AppHourActiveCountDao extends BaseController {
    ...
    */
    public void batchLogicDelete(List<String> ids) {
        ...
        SQL sql = new SQL();
        sql.UPDATE( AppHourActiveCountEntity.tableName );
