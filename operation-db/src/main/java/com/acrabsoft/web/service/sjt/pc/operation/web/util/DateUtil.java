...
public class DateUtil {
    ...
    public static final String DATE_SHORT_MM = "MM-dd";
    ...
    public static String getNowHour() {
        return toString(new Date(), DATE_HH);
    }
     ...
     * @date 2019-06-25
     */
    public static List<String> getMiddleDate2(Date startDate, Date endDate) {
        List<String> list = new ArrayList<>();
        long s = startDate.getTime();
        long e = endDate.getTime();
        Long oneDay = 1000 * 60 * 60 * 24l;
        while (s <= e) {
            startDate = new Date(s);
            list.add(new SimpleDateFormat("MM-dd").format(startDate));
            s += oneDay;
        }
        return list;
    }
