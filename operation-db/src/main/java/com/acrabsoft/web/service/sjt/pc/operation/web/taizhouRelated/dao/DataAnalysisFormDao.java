...
import com.acrabsoft.web.service.sjt.pc.operation.web.taizhouRelated.entity.DataAnalysisFormEntity;
...
/**
* 数据分析形式( DataAnalysisFormDao )Dao类
* @author wanghb
* @since 2021-8-30 20:05:04
*/
@Repository
public class DataAnalysisFormDao extends BaseController {
    @Autowired
    ...
    */
    public void batchLogicDelete(List<String> ids) {
        ...
        SQL sql = new SQL();
        sql.UPDATE( DataAnalysisFormEntity.tableName );
