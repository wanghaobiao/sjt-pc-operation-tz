...
/**
* 权限管理( AuthorityManagementController )控制类
* @author wanghbdeptName
* @since 2021-8-31 10:54:56
*/
@RestController
@RequestMapping("/taizhouRelated/authorityManagement")
@Api(value = "权限管理",  tags = "权限管理")
public class AuthorityManagementController {

    private static Logger logger = Logger.getLogger( AuthorityManagementController.class );
    ...
    */
    ...
    public Result getListPage(@RequestParam(defaultValue = "1") @ApiParam("页码") int pageNo,
        ...
        Result result = authorityManagementService.getListPage( pageNo,pageSize,name,startDate,endDate);
        return result;
    }
    ...
    */
    ...
    public Result view(@RequestParam(name = "id", required =false) @ApiParam("主键id") String id) {
        Result result = authorityManagementService.view( id );
        return result;
    }
    ...
    */
    ...
    public Result saveOrUpdate(@RequestBody AuthorityManagementEntity authorityManagementEntity) {
        Result result = authorityManagementService.saveOrUpdate( authorityManagementEntity );
        return result;
    }
    ...
    */
    ...
    public Result goSave() {
        Result result = authorityManagementService.goSave(  );
        return result;
    }
    ...
    */
    ...
    public Result save(@RequestBody AuthorityManagementEntity authorityManagementEntity) {
        Result result = authorityManagementService.save( authorityManagementEntity );
        return result;
    }
    ...
    */
    ...
    public Result delete(@RequestParam(name = "id", required =false) @ApiParam("主键id") String id) {
        Result result = authorityManagementService.delete( id );
        return result;
    }
    ...
    */
    ...
    public Result batchDelete(@RequestBody List<String> ids) {
        Result result = authorityManagementService.batchDelete( ids );
        return result;
    }*/
    ...
    */
    ...
    public Result logicDelete(@RequestParam(name = "id", required =false) @ApiParam("主键id") String id) {
        Result result = authorityManagementService.logicDelete( id );
        return result;
    }*/
    ...
    */
    ...
    public Result batchLogicDelete(@RequestBody List<String> ids) {
        Result result = authorityManagementService.batchLogicDelete( ids );
        return result;
    }*/
