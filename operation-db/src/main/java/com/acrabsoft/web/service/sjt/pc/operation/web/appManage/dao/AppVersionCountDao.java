...
import com.acrabsoft.web.service.sjt.pc.operation.web.appManage.entity.AppVersionCountEntity;
...
/**
* 应用版本统计( AppVersionCountDao )Dao类
* @author wanghb
* @since 2021-4-27 10:39:02
*/
@Repository
public class AppVersionCountDao extends BaseController {
    @Autowired
    ...
    */
    public void batchLogicDelete(List<String> ids) {
        ...
        SQL sql = new SQL();
        sql.UPDATE( AppVersionCountEntity.tableName );
