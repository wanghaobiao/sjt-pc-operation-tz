...
import com.acrabsoft.web.service.sjt.pc.operation.web.system.entity.SequenceInfo;
...
/**
* 序列表( SequenceDao )Dao类
* @author wanghb
* @since 2020-12-30 18:25:32
*/
@Repository
public class SequenceDao extends BaseController {
    @Autowired
    ...
    */
    public void batchLogicDelete(List<String> ids) {
        ...
        SQL sql = new SQL();
        sql.UPDATE( SequenceInfo.tableName );
