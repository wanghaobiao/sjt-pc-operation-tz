...
import com.acrabsoft.web.service.sjt.pc.operation.web.taizhouRelated.entity.UserManagemerEntity;
...
/**
* 用户管理( UserManagemerDao )Dao类
* @author wanghb
* @since 2021-8-31 10:54:51
*/
@Repository
public class UserManagemerDao extends BaseController {
    @Autowired
    ...
    */
    public void batchLogicDelete(List<String> ids) {
        ...
        SQL sql = new SQL();
        sql.UPDATE( UserManagemerEntity.tableName );
