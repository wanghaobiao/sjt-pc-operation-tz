...
import com.acrabsoft.web.service.sjt.pc.operation.web.appManage.entity.AppOpenCountEntity;
...
/**
* 应用每日人员启动次数统计( AppOpenCountDao )Dao类
* @author wanghb
* @since 2021-4-16 15:58:46
*/
@Repository
public class AppOpenCountDao extends BaseController {
    @Autowired
    ...
    */
    public void batchLogicDelete(List<String> ids) {
        ...
        SQL sql = new SQL();
        sql.UPDATE( AppOpenCountEntity.tableName );
