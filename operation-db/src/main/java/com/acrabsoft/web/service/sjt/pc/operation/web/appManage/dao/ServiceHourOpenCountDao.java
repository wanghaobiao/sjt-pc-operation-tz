...
import com.acrabsoft.web.service.sjt.pc.operation.web.appManage.entity.ServiceHourOpenCountEntity;
...
/**
* 服务分时应用调用次数统计( ServiceHourOpenCountDao )Dao类
* @author wanghb
* @since 2021-4-21 14:46:58
*/
@Repository
public class ServiceHourOpenCountDao extends BaseController {
    @Autowired
    ...
    */
    public void batchLogicDelete(List<String> ids) {
        ...
        SQL sql = new SQL();
        sql.UPDATE( ServiceHourOpenCountEntity.tableName );
